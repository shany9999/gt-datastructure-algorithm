...
public class AVL<T extends Comparable<? super T>> {
    ...
    private AVLNode<T> helper(T data, AVLNode<T> root){
        if (root == null){
            size ++;
    ...
    private AVLNode<T> recur(T data, AVLNode<T> root, AVLNode<T> dummy){
        if (root == null){
    ...
    private AVLNode<T> succes(AVLNode<T> root, AVLNode<T> dummy){
